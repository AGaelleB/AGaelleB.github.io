...
// useApp supprimé car inutile ici, on utilise useT
  ...
  return (
    <section id="contact" ref={ref} style={{ padding: "8rem 2rem", maxWidth: "1200px", margin: "0 auto" }}>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "center" }}>
        ...
        >
          <p className="section-label" style={{ marginBottom: "1.5rem" }}>{t("contact.section_label")}</p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", marginBottom: "3rem" }}>
            <a href="mailto:annegaelle.bonnefoy@gmail.com"
              style={{
                ...
                transition: "opacity 0.2s", display: "inline-block", textAlign: "center",
              }}
            ...
            <a href="https://www.linkedin.com/in/anne-ga%C3%ABlle-bonnefoy-3b7348107/" target="_blank" rel="noopener noreferrer"
              style={{
                fontFamily: "var(--font-mono)", fontSize: "0.85rem", letterSpacing: "0.06em",
                color: "var(--text-muted)", padding: "0.9rem 2rem", borderRadius: "4px",
                textDecoration: "none", border: "1px solid var(--border)",
                transition: "border-color 0.2s, color 0.2s", display: "inline-block", textAlign: "center",
              }}
              onMouseEnter={(e) => {
        ...
        >
          ...
          <div style={{
            ...
            <Image src="/anne-gaelle-2.jpg" alt="Anne-Gaëlle Bonnefoy" fill priority 
